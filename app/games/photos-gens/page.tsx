...
import { RESULT_LEVELS, getResultLevel } from '@/lib/jeu-photos-gens-data';
import { listBucketPhotos, StoragePhoto } from '@/lib/storage-utils';

export default function PhotosGensPage() {
  ...
  useEffect(() => {
    listBucketPhotos('jeu-photos-gens').then(items => {
      setPhotos(items);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-950 px-6">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-yellow-400">Photos Gens</h1>
    ...
    <div className="min-h-screen flex flex-col bg-gray-950 px-4 py-6 text-white">
      <div className="w-full max-w-sm mx-auto flex flex-col gap-4 flex-1">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-lg font-bold text-yellow-400">📸 Photos Gens</h1>
